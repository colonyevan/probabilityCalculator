...
void calcHeader() {
    cout << "This program is incredibly sensitive to input." << endl << endl
...
void exampleHeader() {
    cout << "This requires absolutly no user interaction beyond your choice of which example you would like to see.";
}
